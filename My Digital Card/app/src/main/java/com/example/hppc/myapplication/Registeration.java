...
public class Registeration extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        email.setText(mail);
        String des = getIntent().getExtras().getString("headline");
        designation.setText(des);
        String lnk = getIntent().getExtras().getString("profile");
        linkedin.setText(lnk);
...
//        email.setText(mail);
        ...
        String purl = getIntent().getExtras().getString("picture");
        Picasso.with(getApplicationContext()).load(purl).into(pic);
